...
export const translations = {
  ...
  'nav.docs.map': 'Map',
    ...
    'settings.pages.desc': 'Lege pro Seite fest, ob sie in deiner Navigation sichtbar ist',
    ...
    'settings.groupToggleHint': 'Dieser Schalter beeinflusst den gesamten Bereich inklusive Unterseiten.',
  ...
  'nav.docs.map': 'Map',
    ...
    'settings.pages.desc': 'Choose per page whether it is visible in your navigation',
    ...
    'settings.groupToggleHint': 'This toggle controls the whole section including all child pages.',
